I have implemented the concept of Sparse Matrix in C Programming Language by using the concept of general two dimensional arrays(matrix), and also by using the concept Dynamic Memory Allocation.
